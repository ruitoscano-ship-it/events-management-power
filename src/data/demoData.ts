...
export const demoEventData: EventData = {
  ...
  contributions: [
    { id: 'c1', event_id: DEMO_EVENT_ID, volunteer_id: 'v-ms', item_name: 'Bolo de chocolate', quantity: '2 fatias por mesa', needed_by: '2026-06-13T16:00:00+01:00', status: 'confirmed', notes: 'Coffee break' },
    { id: 'c2', event_id: DEMO_EVENT_ID, volunteer_id: 'v-jc', item_name: 'Quiche Lorraine', quantity: '3 unidades', needed_by: '2026-06-13T12:00:00+01:00', status: 'confirmed', notes: 'Almoço staff' },
    { id: 'c3', event_id: DEMO_EVENT_ID, volunteer_id: 'v-ps', item_name: 'Garrafas de água 1.5L', quantity: '24 unidades', needed_by: '2026-06-13T07:30:00+01:00', status: 'confirmed', notes: null },
    { id: 'c4', event_id: DEMO_EVENT_ID, volunteer_id: 'v-jt', item_name: 'Sumo natural (laranja)', quantity: '5L', needed_by: '2026-06-13T12:00:00+01:00', status: 'pending', notes: null },
  ],
  tasks: [
    ...
    { id: 't7', event_id: DEMO_EVENT_ID, volunteer_id: 'v-rc', schedule_block_id: 's3', title: 'Pista Standard', starts_at: '2026-06-13T09:00:00+01:00', ends_at: '2026-06-13T09:30:00+01:00', status: 'assigned', notes: null },
    { id: 't8', event_id: DEMO_EVENT_ID, volunteer_id: 'v-bs', schedule_block_id: 's3', title: 'Pista Standard', starts_at: '2026-06-13T09:00:00+01:00', ends_at: '2026-06-13T09:30:00+01:00', status: 'assigned', notes: null },
    { id: 't9', event_id: DEMO_EVENT_ID, volunteer_id: 'v-ps', schedule_block_id: 's3', title: 'Pista Standard', starts_at: '2026-06-13T09:00:00+01:00', ends_at: '2026-06-13T09:30:00+01:00', status: 'assigned', notes: null },
